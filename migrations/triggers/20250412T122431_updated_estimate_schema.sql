-- Migrated from: updated_estimate_schema.sql (root directory)
...
CREATE TABLE IF NOT EXISTS public.estimate_items (
    ...
    quantity DECIMAL,
    unit TEXT,
    rate DECIMAL,  -- Renamed from unit_cost to match UI
    amount DECIMAL DEFAULT 0,  -- Renamed from builder_cost to match UI
