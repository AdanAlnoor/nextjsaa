 ...
 * Moves files of specific types to their appropriate directories
 */
const fs = require('fs');
...
// Function to categorize markdown files
  ...
  try {
    ...
    files.forEach(file => {
      ...
      if (ext === '.md') {
        ...
        console.log(`Moved ${file} to ${path.relative(rootDir, targetDir)}`);
        movedCounts.md++;
      } 
