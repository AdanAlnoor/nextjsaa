              ...
              <div key={index} className="p-4 border rounded-md space-y-4">
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    >
                      {item.cost_control_item_id && item.cost_control_item_id !== 'no_tracking' ? (
                        (() => {
                          const selectedItem = costControlItems.find(cc => cc.id === item.cost_control_item_id)
                          return selectedItem ? selectedItem.name : 'Select cost control item for budget tracking'
                        })()
                      ) : item.cost_control_item_id === 'no_tracking' ? (
                        'No budget tracking'
                      ) : (
                        'Select cost control item for budget tracking'
                      )}
                    </Button>
                  </div>
