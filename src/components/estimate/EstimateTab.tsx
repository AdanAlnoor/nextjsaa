...
import { AddEstimateDialog } from '../bq/AddEstimateDialog';
...
export default function EstimateTab() {
  ...
  // Memoize handlers
  const handleAddItem = useCallback((item: EstimateItemInsert) => {
    console.log('Adding item:', item);
    setIsAddDialogOpen(false);
  }, []);

  const openAddDialog = useCallback((level: 0 | 1 | 2, parentId: string | null = null) => {
